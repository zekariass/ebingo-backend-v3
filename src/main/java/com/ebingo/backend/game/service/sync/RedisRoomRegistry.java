...
//                .add(ACTIVE_ROOMS_KEY, roomId.toString()) // convert Long to String
//                .doOnSuccess(c -> log.debug("Added room {} to redis set", roomId))
//                .then();
//    }
//
//    @Override
...
//        return redis.opsForSet()
//                .remove(ACTIVE_ROOMS_KEY, roomId.toString()) // convert Long to String
//                .doOnSuccess(c -> log.debug("Removed room {} from redis set", roomId))
//                .then();
//    }
//
//    @Override
...
//        return redis.opsForSet()
//                .members(ACTIVE_ROOMS_KEY)
//                .doOnSubscribe(s -> log.debug("Fetching active rooms from redis"))
//                .map(Long::valueOf); // convert String back to Long
//    }
//}
